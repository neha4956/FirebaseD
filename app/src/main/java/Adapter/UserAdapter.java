...
import com.example.firebased.MainActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        Log.d("TAG", "onBindViewHolder: " + FirebaseAuth.getInstance().getUid());

        if (firebaseUser!=null && user.getId().equals(FirebaseAuth.getInstance().getUid())){
        ...
        holder.btnFollow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (holder.btnFollow.getText().toString().equals(("follow"))){
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Follow").
                            child((firebaseUser.getUid())).child("following").child(user.getId()).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
